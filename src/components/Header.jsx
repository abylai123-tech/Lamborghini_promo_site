    ...
    <>
      <header>
        <nav>
          <div id='logo'>
            <Link to='/'>
              <img src='../src/assets/images/logo.svg' height={60} />
            </Link>
          </div>
          <div id='navBlock1'>
            <Link to='/models'>
